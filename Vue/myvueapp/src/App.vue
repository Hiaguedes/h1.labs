<template>
  <div style="display: flex;  flex-direction: column; align-items: center;">
   <titulo :titulo="msg"/>
    ...
    <input style="margin: 1rem 0; width: 70%; height: 1.5rem; border-radius: 0.5rem; border: 1px solid rgba(0,0,0,0.3)" :value="filter" v-on:input="filter = $event.target.value" placeholder="Digite algo ..." />
  <ul>
